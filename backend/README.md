...
## Project Structure
    ...
    ├── ramillete_espiritua_28671  # Django project configurations
...
1. Clone this repo and `cd ramillete_espiritua_28671`
...
2. Clone this repo and `cd ramillete_espiritua_28671`
